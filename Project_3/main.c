...
int main() {
    ...
    while (1) {
        ...
        printf("7. Generate Report (Top Student & Average)\n");
        printf("8. Save Data\n");
        printf("9. Load Data\n");
        printf("10. Exit\n");
        printf("Enter choice: ");
        ...
        switch (choice) {
            ...
            case 6: sort_by_gpa(students, count); display_students(students, count); break;
            case 7: 
                print_class_average(students, count); 
                print_top_student(students, count); 
                break;
            case 8: save_to_file(students, count, filename); break;
            case 9: load_from_file(&students, &count, filename); break;
            case 10: 
